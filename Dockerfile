...
RUN apt-get update && apt-get install -y samtools bwa bedtools wget git python-pip python3-pip build-essential zlib1g-dev libbz2-dev liblzma-dev
RUN pip3 install numpy scipy pysam bx-python Cython matplotlib
